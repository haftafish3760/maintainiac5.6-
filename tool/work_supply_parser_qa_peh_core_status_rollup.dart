...
const _usage =
    ...
    '[--electrical-status build/parser_qa_pipeline/electrical_core_generated_run_status_samples.json] '
    '[--hvac-status build/parser_qa_pipeline/hvac_core_generated_run_status_samples.json] '
    '[--electrical-target-checked 50] [--hvac-target-checked 50] '
    '[--output build/parser_qa_pipeline/peh_core_windows_status_rollup.json]';
...
int runWorkSupplyParserQaPehCoreStatusRollup(
  List<String> args, {
  ...
  final summary = {
    'schemaVersion': 1,
    'report': 'work_supply_parser_qa_peh_core_status_rollup',
    'targetChecked': {
      'plumbing': 100,
  ...
  stdout.writeln('QA_PEH_CORE_STATUS_ROLLUP_ARTIFACT json=${file.path}');
...
Map<String, Object?> _readTradeStatus({
  ...
  return {
    ...
    'readyForMacMeasurementWave': localOnlySafe && failureCount == 0,
    'readyToClaimNinetyPlus':
