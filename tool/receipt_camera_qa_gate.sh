...
case "$mode" in
  phase2 | phase3 | phase4 | phase5 | quick | stitch | milestone | full) ;;
  *)
    echo "Usage: tool/receipt_camera_qa_gate.sh [--print-plan] [phase2|phase3|phase4|phase5|quick|stitch|milestone|full]" >&2
    exit 64
    ;;
esac
