...
''',
  ...
  test('dot-grouped kilometer odometer cannot populate miles', () {
    final result = parseMaintenanceReceipt(
      const MaintenanceReceiptParserInput(
        activeVehicleId: 'vehicle_1',
        sourceText: '''
...
''',
  ...
  test('apostrophe-grouped kilometer schedule remains unset', () {
    final result = parseMaintenanceReceipt(
      const MaintenanceReceiptParserInput(
        activeVehicleId: 'vehicle_1',
        sourceText: '''
...
''',
  ...
  test('dot-grouped mile odometer remains an editable suggestion', () {
    final result = parseMaintenanceReceipt(
      const MaintenanceReceiptParserInput(
        activeVehicleId: 'vehicle_1',
        sourceText: '''
