...
void main() {
  test('accepted review freezes privacy-safe handoff metadata count maps', () {
    ...
    expect(
      handoffMetadata,
      containsPair('receiptReaderHandoffSchema', 'receipt_reader_handoff_v1'),
    );
    expect(
      handoffMetadata,
      containsPair('receiptDetailsHandoffSchema', 'receipt_details_handoff_v1'),
    );
    expect(
      handoffMetadata,
      containsPair('receiptReviewExitAction', 'accepted_for_receipt_details'),
    );
    expect(handoffMetadata, containsPair('receiptReviewKeptForLater', false));
    expect(
      handoffMetadata,
      containsPair(
    ...
    expect(handoffMetadata['receiptReaderHandoffCounts'], {
    ...
    expect(handoffMetadata['receiptDetailsHandoffCounts'], {
      'saved_backup_present': 1,
      'ocr_source_present': 1,
      'ocr_source_separate_from_backup': 1,
      'ocr_source_review_risk_ocr_source_ready': 1,
