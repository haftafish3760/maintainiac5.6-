  ...
  test(
    ...
    () async {
      ...
      expect(
        ...
        contains(
          'Usage: tool/receipt_start_camera_qa_gate.sh [phase2|phase3|phase4|phase5|phase6|phase7|phase8|phase9|quick|stitch|milestone|full]',
        ),
      );
    },
  );

  test('camera QA gate exposes phase2 phase3 phase4 phase5 phase6 phase7 phase8 phase9 quick stitch milestone and full modes', () {
    ...
    expect(script, contains('phase2 | phase3 | phase4 | phase5 | phase6 | phase7 | phase8 | phase9 | quick | stitch | milestone | full'));
