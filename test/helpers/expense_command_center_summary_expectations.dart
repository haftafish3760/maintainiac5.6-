...
void expectExpenseCommandCenterSummaryTelemetry(
  ...
  String encoded,
    ...
    expect(
      snapshot.topPreCaptureExposureDecision,
    ...
    expect(
      snapshot.topNativeCameraIdentity,
    ...
    expect(
      snapshot.topReceiptCloudFallbackParserPackCode,
      'cloud_ocr_assist_v1',
    );
    expect(
    ...
    expect(
      snapshot.topCapabilityPolicyCode,
      'storage_constrained_small_proofs',
    );
    expect(snapshot.nativeCaptureSourcePolicyCounts, {
    ...
    expect(map['capturedPhotoQualitySignalCounts'], {
      'review_before_saving': 1,
    });
    expect(map['capturedPhotoBottomBrightnessCounts'], {'bottom_dim': 1});
    expect(map['capturedPhotoBottomEdgeScoreCounts'], {
      'bottom_edge_usable': 1,
    });
    ...
    expect(
      map['topNativeControlContractVersion'],
      'receipt_native_controls_v1',
    );
