...
void expectExpenseParserCategorySummaryTelemetry(
  ...
  String encoded,
      ...
      expect(snapshot.receiptBrainFullOfflineMustStayOptionalCounts, {
        'true': 1,
      });
      expect(snapshot.receiptBrainBaseLocalReadingAvailableCounts, {'true': 1});
      expect(snapshot.receiptBrainBaseWorksWithoutCloudAssistCounts, {
        'true': 1,
      });
      ...
      expect(snapshot.receiptBrainLocalFirstReadinessSummaryCounts, {
        'present': 1,
      });
      ...
      expect(snapshot.receiptBrainFirstInstallCanRunLowStorageCounts, {
        'true': 1,
      });
      ...
      expect(snapshot.receiptInstallOptionalPacksRequireConsentCounts, {
        'true': 1,
      });
      ...
      expect(snapshot.nativeLocalOnlyHeavyPacksMayBlockCaptureCounts, {
        'false': 1,
      });
      ...
      expect(
        map['topParserRequiredFieldStatus'],
        'parser_required_missing_total',
      );
