...
void main() {
  ...
  test('capability diagnostics labels expose tier limits clearly', () {
    ...
    expect(light.stitchLimits.evidenceTimeout, const Duration(seconds: 2));
    expect(
      light.stitchLimits.processingTimeout,
    ...
    expect(heavy.stitchLimits.maxTargetWidth, 1240);
    expect(heavy.stitchLimits.evidenceTimeout, const Duration(seconds: 3));
    expect(heavy.stitchLimits.processingTimeout, const Duration(seconds: 8));
