...
Future<List<File>> _writeMixedSourceStack(String prefix) async {
  ...
  for (var index = 0; index < starts.length; index++) {
    ...
    if (index == 2) {
      receiptWindow = fadeReceiptStitchingInk(receiptWindow, amount: .10);
    }
    final section = index.isEven
        ? receiptWindow
