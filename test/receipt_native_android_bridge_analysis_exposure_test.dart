...
void main() {
  test(
    'Android native receipt camera keeps live analysis and exposure guardrails',
    () async {
      ...
      expect(
        cameraActivity,
        contains(
          'intent.getBooleanExtra("orientationCorrectionEnabled", true)',
        ),
      );
      expect(
        cameraActivity,
      ...
      expect(
        cameraActivity,
        contains(
          '"nativeTapFocusGesturePolicy" to "removed_continuous_focus_readability_primary"',
        ),
      );
