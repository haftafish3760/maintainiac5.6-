...
void main() {
  test('hosted catalog export writes manifest and gzipped chunks', () async {
  ...
  test('hosted catalog export manifest stays Firestore lightweight', () async {
    final base = await Directory.systemTemp.createTemp(
  ...
  test('hosted catalog export chunks match manifest checksums', () async {
    final base = await Directory.systemTemp.createTemp(
    ...
    final chunkFile = File('${result.directoryPath}/${firstChunk.storagePath}');
