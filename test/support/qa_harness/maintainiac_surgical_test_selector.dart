...
const maintainiacSurgicalTestSelectorRegistry = MaintainiacSurgicalTestSelectorRegistry([
  ...
  MaintainiacSurgicalTestSelector(
    id: 'qa_case_registry_commands_have_selectors',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_qa_case_registry_test.dart',
    plainName: 'QA case registry commands are covered by surgical selectors',
    reason: 'Run only the QA case command-to-selector alignment check.',
    tags: {'qa-registry', 'release-gate', 'surgical'},
  ),
  MaintainiacSurgicalTestSelector(
  ...
  MaintainiacSurgicalTestSelector(
    id: 'surgical_rerun_router_critical_family_coverage',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_surgical_rerun_router_test.dart',
    plainName: 'surgical rerun router covers all critical selector families',
    reason: 'Run only the critical selector-family routing completeness guard.',
    tags: {'parser-consumer', 'tooling', 'regression', 'surgical'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'surgical_rerun_router_expanded_qa_safety_guards',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_surgical_rerun_router_test.dart',
    plainName: 'surgical rerun router maps expanded QA safety guards',
    reason: 'Run only the expanded QA safety guard routing check.',
    tags: {'parser-consumer', 'tooling', 'regression', 'surgical'},
  ),
  MaintainiacSurgicalTestSelector(
  ...
  MaintainiacSurgicalTestSelector(
    id: 'surgical_rerun_router_reaches_every_selector',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_surgical_rerun_router_test.dart',
    plainName:
        'surgical rerun router reaches every selector from its test file',
    reason: 'Run only the dead-selector reachability guard.',
    tags: {'parser-consumer', 'tooling', 'regression', 'surgical'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'surgical_rerun_router_matchers_real_files',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_surgical_rerun_router_test.dart',
    plainName: 'surgical rerun router matchers point at real files',
    reason: 'Run only the stale changed-path matcher guard.',
    tags: {'parser-consumer', 'tooling', 'regression', 'surgical'},
  ),
  MaintainiacSurgicalTestSelector(
  ...
  MaintainiacSurgicalTestSelector(
    id: 'qa_runner_lists_groups',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_qa_runner_tool_test.dart',
    plainName: 'QA runner lists reusable whole-app groups',
    reason: 'Run only the QA runner group discovery check.',
    tags: {'qa-runner', 'qa-backbone', 'release-gate'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'qa_runner_validates_without_flutter',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_qa_runner_tool_test.dart',
    plainName: 'QA runner validates contracts without launching Flutter',
    reason: 'Run only the QA runner fast contract validation check.',
    tags: {'qa-runner', 'performance', 'release-gate'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'qa_runner_bounded_json',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_qa_runner_tool_test.dart',
    plainName: 'QA runner emits bounded JSON by default',
    reason: 'Run only the QA runner non-noisy JSON report guard.',
    tags: {'qa-runner', 'privacy', 'performance'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'qa_runner_changed_surgical_commands',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_qa_runner_tool_test.dart',
    plainName: 'QA runner resolves changed files to surgical commands only',
    reason: 'Run only the QA runner changed-file surgical command check.',
  ...
  MaintainiacSurgicalTestSelector(
    ...
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_qa_runner_tool_test.dart',
    plainName: 'QA runner rejects unknown groups',
    reason: 'Run only the QA runner invalid group negative check.',
    tags: {'qa-runner', 'security', 'regression'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'parser_pipeline_dry_run_safe_plan',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/work_supply_parser_qa_pipeline_test.dart',
    plainName: 'economical pipeline dry-run plans every local step safely',
    reason: 'Run only the parser pipeline dry-run planning check.',
    tags: {'inventory', 'parser-pipeline', 'release-gate'},
  ),
  MaintainiacSurgicalTestSelector(
  ...
  MaintainiacSurgicalTestSelector(
    id: 'parser_pipeline_resume_local_artifacts',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/work_supply_parser_qa_pipeline_test.dart',
    plainName: 'economical pipeline resume reuses existing local artifacts',
    reason: 'Run only the parser pipeline resume reuse check.',
    tags: {'inventory', 'parser-pipeline', 'performance'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'parser_pipeline_caps_fixture_runs',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/work_supply_parser_qa_pipeline_test.dart',
    plainName: 'economical pipeline can cap parser fixture runs separately',
    reason: 'Run only the parser pipeline fixture run cap check.',
    tags: {'inventory', 'parser-pipeline', 'performance'},
  ),
  MaintainiacSurgicalTestSelector(
  ...
  MaintainiacSurgicalTestSelector(
    ...
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName: 'refuses a retry-ledger write when device storage is critical',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'durable-storage', 'regression', 'privacy'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_does_not_replace_an_existing_retry_entry_when_storage_is_critical',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName:
  ...
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_upload_sinks_cannot_mutate_queued_document_payloads',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName: 'upload sinks cannot mutate queued document payloads',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'durable-storage', 'regression', 'privacy'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_free_sync_quota_exhaustion_preserves_pending_uploads',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName: 'free sync quota exhaustion preserves pending uploads',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'durable-storage', 'regression', 'privacy'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_free_sync_quota_is_read_at_upload_time',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName: 'free sync quota is read at upload time',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'durable-storage', 'regression', 'privacy'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_broken_free_sync_quota_reads_fail_closed_without_uploading',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName: 'broken free sync quota reads fail closed without uploading',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'durable-storage', 'regression', 'privacy'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_malformed_free_sync_quota_counts_fail_closed_without_uploading',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName: 'malformed free sync quota counts fail closed without uploading',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'durable-storage', 'regression', 'privacy'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_network_policy_block_preserves_pending_uploads',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName: 'network policy block preserves pending uploads',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'durable-storage', 'regression', 'privacy'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_broken_network_policy_checks_preserve_pending_uploads',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName: 'broken network policy checks preserve pending uploads',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'durable-storage', 'regression', 'privacy'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_concurrent_flushes_upload_a_queued_document_only_once',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName: 'concurrent flushes upload a queued document only once',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'durable-storage', 'regression', 'privacy'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_replacement_queues_the_newer_document_before_removing_retry_evide',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName:
  ...
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_concurrent_replacements_preserve_one_newest_pending_document',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName: 'concurrent replacements preserve one newest pending document',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'durable-storage', 'regression', 'privacy'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_a_stale_failed_upload_cannot_resurrect_a_replaced_queue_entry',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName: 'a stale failed upload cannot resurrect a replaced queue entry',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'durable-storage', 'regression', 'privacy'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_never_discards_pending_uploads_when_the_queue_exceeds_its_soft_ca',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName:
  ...
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_pending_upload_survives_a_local_queue_restart_without_duplication',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName:
  ...
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_malformed_stored_retry_metadata_is_sanitized_on_restore',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName: 'malformed stored retry metadata is sanitized on restore',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'durable-storage', 'regression', 'privacy'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_malformed_queued_document_data_is_sanitized_on_restore',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName: 'malformed queued document data is sanitized on restore',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'durable-storage', 'regression', 'privacy'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_unsafe_restored_queue_records_are_not_retried_or_uploaded',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName: 'unsafe restored queue records are not retried or uploaded',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'durable-storage', 'regression', 'privacy'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_does_not_retry_a_failed_cloud_write_before_its_durable_backoff_is',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName:
  ...
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_clock_rollback_cannot_shorten_a_durable_cloud_retry_backoff',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName: 'clock rollback cannot shorten a durable cloud retry backoff',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'durable-storage', 'regression', 'privacy'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_firestore_upload_queue_a_failed_upload_retries_successfully_after_a_local_queue_restart',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_firestore_upload_queue_test.dart',
    plainName:
  ...
  MaintainiacSurgicalTestSelector(
    ...
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_hosted_cache_test.dart',
    plainName: 'treats a tampered persisted cache value as a cache miss',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'hosted-cache', 'security', 'regression'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_hosted_cache_malformed_persisted_cache_data_keys_are_sanitized_on_restore',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_hosted_cache_test.dart',
    plainName: 'malformed persisted cache data keys are sanitized on restore',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'hosted-cache', 'security', 'regression'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'work_supply_parser_generated_fixture_runner_generated_fixture_runner_selects_fixture_chunks_by_offse',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/work_supply_parser_generated_fixture_runner_test.dart',
    plainName: 'generated fixture runner selects fixture chunks by offset',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'inventory', 'generated-fixtures', 'regression'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'work_supply_parser_generated_fixture_runner_generated_fixture_runner_validates_receipt_envelope_item',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/work_supply_parser_generated_fixture_runner_test.dart',
    plainName: 'generated fixture runner validates receipt envelope item lines',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'inventory', 'generated-fixtures', 'regression'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'work_supply_parser_generated_fixture_runner_generated_fixture_warmup_keeps_each_fixture_trade_scope',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/work_supply_parser_generated_fixture_runner_test.dart',
    plainName: 'generated fixture warmup keeps each fixture trade scope',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'inventory', 'generated-fixtures', 'regression'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'work_supply_parser_generated_fixture_runner_generated_fixture_report_records_no_warmup_by_default',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/work_supply_parser_generated_fixture_runner_test.dart',
    plainName: 'generated fixture report records no warmup by default',
    reason: 'Run only this focused behavior after its owning system changes.',
    tags: {'inventory', 'generated-fixtures', 'regression'},
  ),
  MaintainiacSurgicalTestSelector(
    id: 'maintainiac_qa_backbone_report_safety_gate_validates_runtime_report_shape',
    scope: MaintainiacSurgicalTestScope.singleBehavior,
    file: 'test/maintainiac_qa_backbone_test.dart',
    plainName: 'report safety gate validates runtime report shape',
    reason: 'Run only this focused behavior after its owning system changes.',
