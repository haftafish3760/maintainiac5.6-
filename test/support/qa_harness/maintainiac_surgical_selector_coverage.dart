  ...
  expectations: [
    ...
    MaintainiacSurgicalCoverageExpectation(
      ...
      plainNames: {
        ...
        'upload sinks cannot mutate queued document payloads',
        'free sync quota exhaustion preserves pending uploads',
        'free sync quota is read at upload time',
        'broken free sync quota reads fail closed without uploading',
        'malformed free sync quota counts fail closed without uploading',
        'network policy block preserves pending uploads',
        'broken network policy checks preserve pending uploads',
        'concurrent flushes upload a queued document only once',
        ...
        'malformed stored retry metadata is sanitized on restore',
        'malformed queued document data is sanitized on restore',
        'unsafe restored queue records are not retried or uploaded',
        'does not retry a failed cloud write before its durable backoff is due',
        'clock rollback cannot shorten a durable cloud retry backoff',
    ...
    MaintainiacSurgicalCoverageExpectation(
      ...
      plainNames: {
        ...
        'surgical rerun router maps expanded QA safety guards',
        'surgical rerun router maps selector registry safety guards',
        'surgical rerun router reaches every selector from its test file',
        'surgical rerun router matchers point at real files',
    ...
    MaintainiacSurgicalCoverageExpectation(
      ...
      plainNames: {
        ...
        'QA artifact policy rejects path traversal artifacts',
      },
    ),
    MaintainiacSurgicalCoverageExpectation(
    ...
    MaintainiacSurgicalCoverageExpectation(
      ...
      plainNames: {
        ...
        'generated fixture runner selects fixture chunks by offset',
        'generated fixture runner validates receipt envelope item lines',
        'generated fixture warmup keeps each fixture trade scope',
        'generated fixture report records no warmup by default',
      },
    ),
    MaintainiacSurgicalCoverageExpectation(
      ...
      plainNames: {
        ...
        'report safety gate validates runtime report shape',
      },
    ),
  ],
);
