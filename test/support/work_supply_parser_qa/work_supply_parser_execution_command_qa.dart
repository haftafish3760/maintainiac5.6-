...
class WorkSupplyParserExecutionCommandSuite extends QaSuite {
  ...
  static const _documentedCommands = [
    ...
    _CommandContract('peh_core_mac_wave_status', [
    ...
    _CommandContract('peh_core_restamp_handoff', [
    ...
    _CommandContract('peh_core_post_mac_refresh', [
  ...
  static const _toolSourceContracts = [
    ...
    _ToolSourceContract(
      name: 'peh_core_mac_wave_status_readout',
      path: _pehCoreMacWaveStatusPath,
      tokens: [
        'QA_PEH_CORE_MAC_WAVE_STATUS',
        'QA_PEH_CORE_MAC_WAVE_STATUS_ARTIFACT',
        'completedRollupCount',
        'missingRollupCount',
        'readyTradeCount',
    ...
    _ToolSourceContract(
      ...
      tokens: [
        ...
        'QA_PEH_CORE_MAC_HANDOFF_PACKET_ARTIFACT',
        'measurementCommandCount',
        'rollupCommandCount',
        'expectedOutputs',
        'refreshCommand',
    ...
    _ToolSourceContract(
      name: 'peh_core_claim_readiness_readout',
      path: _pehCoreClaimReadinessPath,
      tokens: [
        'QA_PEH_CORE_CLAIM_READINESS',
        'QA_PEH_CORE_CLAIM_READINESS_ARTIFACT',
        'tradeClaimCount',
        'readyToClaimNinetyPlus',
        'readyToClaimNinetyFive',
        'tradeClaims',
        'blockingFindings',
        'nextActions',
        'plumbing',
