...
void main() {
  ...
  test('retaking top or bottom section keeps the correct ghost-guide context', () {
    ...
    expect(topPlan.alignmentContext.guidanceCode, 'retake_top_with_next_context');
  ...
  test('native session keeps long-receipt ghost guide policy for continuation and retake', () {
    ...
    expect(topRetake.previousSectionGhostSlicePercent, 22);
  });
}
