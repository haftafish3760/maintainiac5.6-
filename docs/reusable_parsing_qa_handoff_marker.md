...
- Commit label:
  `Reusable parsing QA 2026-07-09 20:46 EDT: bind Mac handoff to reusable baseline`

The Mac Mini side should start from branch `codex/reusable-parsing-qa-foundation`.
Treat the branch tip as authoritative.
Treat commit `b085844` as the last Windows-validated floor, not as a promise
...
`b085844`, read this marker first, then continue only with heavier validation,
