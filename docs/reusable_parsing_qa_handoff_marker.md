...
- Current reusable-foundation commit: `fe15ba3`
- Commit label:
  `Reusable parsing QA 2026-07-09 20:05 EDT: embed baseline commit in Mac handoff packet`
...
`fe15ba3`, read this marker first, then continue only with heavier validation,
