...
- Verified 2026-07-23 evidence: 30 maintenance persistence/draft/UI/history
  tests, 69 selected vehicle/global-odometer tests, and the 203-check maintenance
  receipt gate passed. The receipt gate includes 197 parser/review/draft/UI/
...
`docs/maintenance_receipt_parser_pass_log.md`. The current accepted pass is 58;
the next bundled app-work pass is 59. Duplicate-line cleanup remains OCR-owned,
not parser-owned.
