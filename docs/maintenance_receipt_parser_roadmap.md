...
also scoped rather than downgrading unrelated earlier work.
...
`docs/maintenance_receipt_parser_pass_log.md`. The current accepted pass is 62;
the next bundled app-work pass is 63. Duplicate-line cleanup remains OCR-owned,
not parser-owned.
