...
- Latest stable commit: `6a782469e` (fractional activity-confidence platform regression)
- Latest validation result: engine and platform regressions plus scoped analysis green after timestamp and walking-evidence boundary hardening; prior GPS QA gate, Android Kotlin compile, and iOS device build green
