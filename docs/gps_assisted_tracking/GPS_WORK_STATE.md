...
- Latest stable commit: `57b8b4848` (private speed-quality diagnostic regression)
- Latest validation result: GPS QA gate, scoped analysis, Android Kotlin compile, and iOS device build green; controller, engine, platform, provider-summary, native-sampling, and native-contract regressions green
