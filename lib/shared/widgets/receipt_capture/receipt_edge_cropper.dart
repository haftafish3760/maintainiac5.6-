...
class ReceiptEdgeCropper extends StatelessWidget {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        if (cropRect == null) {
          _notifyAfterLayout(
            context,
            () => onCropRectChanged(activeCropRect),
          );
        }
        return Stack(
          fit: StackFit.expand,
  ...
  Rect? _suggestedCropRect(Rect imageRect, Rect? normalizedCrop) {
    ...
    final left = (imageRect.left + imageRect.width * normalizedCrop.left)
        .clamp(imageRect.left, imageRect.right);
    final top = (imageRect.top + imageRect.height * normalizedCrop.top)
