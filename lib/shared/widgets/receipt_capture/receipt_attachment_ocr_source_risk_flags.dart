...
extension _ReceiptAttachmentOcrSourceRiskFlags
  ...
  List<String> ocrSourceRiskFlagsFor(
    ...
    if (result.stitchResult.failedPairLabel.isNotEmpty) {
      flags.add(
        'ocr_source_stitch_failed_pair_${attachmentSignalToken(result.stitchResult.failedPairLabel)}',
      );
    }
    if (result.stitchResult.reviewFocusPairLabel.isNotEmpty) {
      flags.add(
        'ocr_source_stitch_review_focus_pair_${attachmentSignalToken(result.stitchResult.reviewFocusPairLabel)}',
      );
    }
