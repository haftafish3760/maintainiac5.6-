...
extension _ReceiptPhotoReviewSurfaceControls on _ReceiptPhotoReviewScreenState {
  Widget _buildReviewBottomControls(String photoPath) {
    ...
    final controls = _ReceiptReviewBottomControls(
      ...
      straightenControlsVisible: _straightenControlsVisible,
      straightenAngleDegrees: _straightenAngleDegrees,
      onToggleStraighten: _toggleStraightenControls,
      onStraightenAngleChanged: _setStraightenAngle,
      onApplyStraighten: () => unawaited(_applyStraightenAdjustment()),
