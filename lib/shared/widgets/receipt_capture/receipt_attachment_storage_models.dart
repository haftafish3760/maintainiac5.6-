...
enum ReceiptDataSaverLevel {
  ...
  balanced(
    'Normal',
    '800 KB-1 MB',
    'Everyday saved proof image with a 1 MB ceiling.',
  ),
  strong(
    'Low Storage',
    '450-650 KB',
  ...
  factory ReceiptProofTargetSizePolicy.forLevel(ReceiptDataSaverLevel level) {
    return switch (level) {
      ...
      ReceiptDataSaverLevel.light => const ReceiptProofTargetSizePolicy(
        ...
        policyCode: 'high_quality_proof_1200_1500kb',
        minBytes: 1200 * 1024,
        targetBytes: 1350 * 1024,
        maxBytes: 1500 * 1024,
      ...
      ReceiptDataSaverLevel.balanced => const ReceiptProofTargetSizePolicy(
        ...
        policyCode: 'normal_proof_800_1000kb',
        minBytes: 800 * 1024,
      ...
      ReceiptDataSaverLevel.strong => const ReceiptProofTargetSizePolicy(
        ...
        policyCode: 'low_storage_proof_450_650kb',
        minBytes: 450 * 1024,
      ...
      ReceiptDataSaverLevel.maximum => const ReceiptProofTargetSizePolicy(
        ...
        policyCode: 'tiny_proof_200_350kb',
        minBytes: 200 * 1024,
