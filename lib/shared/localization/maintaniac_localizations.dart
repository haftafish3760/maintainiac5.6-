...
class MaintaniacLocalizations {
  ...
  String get expenseOdometerRequiredTitle => _text(
    'Odometer Reading Required',
    'Lectura del odómetro obligatoria',
    'Lecture de l’odomètre obligatoire',
  );
  String get expenseOdometerRequiredExplanation => _text(
    'Every expense needs the vehicle odometer reading from when it happened. This keeps mileage, stops, and expense records connected.',
    'Cada gasto necesita la lectura del odómetro del vehículo del momento en que ocurrió. Esto mantiene conectados el millaje, las paradas y los gastos.',
    'Chaque dépense exige la lecture de l’odomètre du véhicule au moment où elle a eu lieu. Cela relie le kilométrage, les arrêts et les dépenses.',
  );
