...
class AppPdfPrivacyPolicy {
  ...
  static bool _containsVin(String text) {
    return RegExp(
          r'(?:^|[^a-z0-9])(?:vin|vehicle identification number)[\s_-]*[:#-]?[\s_-]*[a-hj-npr-z0-9]{17}\b',
        ).hasMatch(text) ||
  ...
  static bool _containsLicensePlate(String text) {
    return RegExp(
      r'(?:^|[^a-z0-9])(?:license plate|plate number|plate|tag number|vehicle tag)[\s_-]*[:#-]?[\s_-]*[a-z0-9][a-z0-9 _-]{2,10}\b',
    ).hasMatch(text);
  }
