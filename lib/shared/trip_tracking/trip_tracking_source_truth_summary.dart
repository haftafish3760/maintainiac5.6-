...
class TripTrackingSourceTruthSummary {
  ...
  Map<String, Object?> toSafeDashboardMap() => {
    ...
    'remoteTotalsRejectedAtTrustBoundary': true,
    'mapboxRoutesRejectedAsOfficialMileage': true,
    'cloudFunctionsCanOverrideLocalDay': false,
    'firebaseAuthDoesNotGrantRecordOwnership': true,
    ...
    'gpsAssistanceCannotCreateOfficialMileage': true,
