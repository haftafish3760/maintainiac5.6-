...
class TripDashboardWidgetImportDecision {
  ...
  Map<String, Object?> toSafeDashboardMap() => {
    ...
    'importedWidgetCanSetGlobalTruth': false,
    'importedWidgetCanChangeOfficialMileage': false,
...
class TripDashboardWidgetImportSummaryValidation {
  ...
  factory TripDashboardWidgetImportSummaryValidation.fromSummary(
    ...
    for (final key in const [
      ...
      'importedWidgetCanSetGlobalTruth',
      'importedWidgetCanChangeOfficialMileage',
