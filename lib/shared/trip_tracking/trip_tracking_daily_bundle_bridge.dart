...
/// Stores compact, sync-eligible summaries for all reviewed trips that began
/// on the same local calendar day. Detailed per-trip records remain local and
/// independently recoverable through [TripTrackingDurableRecordBridge].
