...
class TripTrackingSyncSourceRecord {
  ...
  Map<String, Object?> toSafeSyncMirrorPayload() {
    return {
      ...
      'ownerValidatedBeforeMirror': true,
      'canOverrideLocalDaytimeData': false,
      'canDeleteLocalData': false,
      'odometerIsGlobalTruth': true,
      'odometerRemainsOfficialMileageTruth': true,
      'calibrationCanUploadAsOfficialMileage': false,
...
class TripTrackingSyncAttemptDecision {
  ...
  Map<String, Object?> toSafeSummary() {
    return {
      ...
      'deviceIdMatchesLocalRecord': true,
      'tripDayKeyValidated': true,
      'mirrorPayloadHasMonotonicLocalRevision': true,
      ...
      'authenticationAloneAuthorizesMirrorUpload': false,
