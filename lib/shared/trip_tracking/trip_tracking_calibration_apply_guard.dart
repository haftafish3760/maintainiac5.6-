...
class TripTrackingCalibrationApplyGuard {
  ...
  Map<String, Object?> toSafeDashboardMap() => {
    ...
    'gpsAssistedTrackingConsentRequired': true,
    'separateCalibrationOptInRequired': false,
    'reviewAcceptanceRequiredForAdvisoryProjection': false,
    'automaticLocalAdvisoryCalibrationEnabledByGpsConsent': true,
