...
/// review. Candidates fill only missing values and never replace a parser or
/// user value; every candidate-filled field remains marked for review.
ExpenseReceiptParseResult fillMissingExpenseReceiptFieldsFromOcrCandidates(
  ...
  final merchantValue = parsedMerchant.isEmpty
      ? merchantEvidence
      : parsed.merchantName;
  ...
  _addCandidateConfidence(
    fieldConfidences,
    key: 'merchant',
    candidate: parsedMerchant.isEmpty && merchantEvidence != null
        ? merchant
        : null,
