...
class _SystemSettingsContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        _ScreenNavigationPanel(),
        const SizedBox(height: 12),
        const _SettingsSurface(
          title: 'System Settings',
          intro:
              'App-wide controls for storage, security, backup, exports, and device permissions.',
          sections: [
            _SettingsSection(
              title: 'Security',
              rows: [
                'App lock and biometric unlock',
                'Business and personal record separation',
                'Local audit history protection',
              ],
            ),
            _SettingsSection(
              ...
              rows: [
                'Hive local database',
                'Firebase backup layer',
                'Google Drive, iCloud, and file export',
              ],
            ),
            _SettingsSection(
              title: 'Permissions',
              rows: [
                'Camera for receipts',
                'Files for PDF and image uploads',
                'Notifications for optional reminders',
              ],
            ),
          ],
        ),
