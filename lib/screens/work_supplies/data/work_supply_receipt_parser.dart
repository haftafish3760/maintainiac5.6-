...
ReceiptLineMatch? matchReceiptLineToCatalog(
  ...
  if (_isBareMixedSizedTubeReceiptLine(normalized, tradeScope)) {
    return null;
  }
  ...
  if (_isBareMixedSizedLineReceiptLine(normalized, tradeScope)) {
    return null;
  }
  if (_isBareMixedSwitchReceiptLine(normalized, tradeScope)) {
    return null;
  }
  if (_isBareMixedSizedSwitchReceiptLine(normalized, tradeScope)) {
    return null;
  }
  if (_isBareMixedCoverReceiptLine(normalized, tradeScope)) {
    return null;
  }
  if (_isBareMixedSizedCoverReceiptLine(normalized, tradeScope)) {
    return null;
  }
  ...
  if (_isBareMixedSizedCleanoutReceiptLine(normalized, tradeScope)) {
    return null;
  }
  if (_isBareMixedCapReceiptLine(normalized, tradeScope)) {
    return null;
  }
  if (_isBareMixedSizedCapReceiptLine(normalized, tradeScope)) {
    return null;
  }
  ...
  if (_isBareMixedSizedCouplingReceiptLine(normalized, tradeScope)) {
    return null;
  }
  if (_isBareMixedCtsCouplingReceiptLine(normalized, tradeScope)) {
    return null;
  }
  ...
  if (_isBareMixedConnectorKitReceiptLine(normalized, tradeScope)) {
    return null;
  }
  if (_isBareMixedConduitReceiptLine(normalized, tradeScope)) {
    return null;
  }
  if (_isBareMixedSizedConduitReceiptLine(normalized, tradeScope)) {
    return null;
  }
  if (_isBareMixedBoxReceiptLine(normalized, tradeScope)) {
    return null;
  }
  if (_isBareMixedSizedBoxReceiptLine(normalized, tradeScope)) {
    return null;
  }
  if (_isBareMixedJBoxReceiptLine(normalized, tradeScope)) {
    return null;
  }
  ...
  if (_isBareMixedSaltPelletsReceiptLine(normalized, tradeScope)) {
    return null;
  }
