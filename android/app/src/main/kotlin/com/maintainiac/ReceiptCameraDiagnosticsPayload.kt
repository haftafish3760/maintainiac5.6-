...
internal fun ReceiptCameraActivity.nativeCaptureDiagnostics(
    ...
    val diagnostics = hashMapOf<String, Any>(
        ...
        "experimentalReceiptQualityRequiredFrames" to experimentalReceiptQualityRequiredFrames,
        ...
        "captureTimeoutCount" to captureTimeoutCount,
        "captureTimeoutMs" to captureTimeoutMs,
        "lastCaptureTrigger" to lastCaptureTrigger,
        "lastCaptureBlockReason" to lastCaptureBlockReason,
        "cameraStartAttemptCount" to cameraStartAttemptCount,
        "cameraStartFailureCount" to cameraStartFailureCount,
        "lastCameraStartStatus" to lastCameraStartStatus,
        ...
        "captureShutterZoomByPath" to HashMap(captureShutterZoomByPath),
        "sessionMinZoom" to sessionMinZoom,
        "sessionMaxZoom" to sessionMaxZoom,
        "sessionInitialZoom" to sessionInitialZoom,
