...
extension ReceiptCameraViewController {
  func nativeCaptureDiagnostics(
    ...
    return [
      ...
      "sessionWasInterrupted": sessionWasInterrupted,
      "sessionInterruptionCount": sessionInterruptionCount,
      "sessionRuntimeErrorCount": sessionRuntimeErrorCount,
      "sessionRecoveryAttemptCount": sessionRecoveryAttemptCount,
      "lastSessionRecoveryStatus": lastSessionRecoveryStatus,
      "captureOrientationUpdateCount": captureOrientationUpdateCount,
      "lastCaptureOrientation": lastCaptureOrientation,
      ...
      "latestCaptureShutterZoomRatio": latestCaptureShutterZoomRatio,
      "minZoomRatio": 1,
